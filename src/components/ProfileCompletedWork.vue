...
Science
              ...
              <td>
                ...
                <span
                  v-else-if="standard.completed == 'Progressing Towards Achieved' || standard.completed == 'PTA' "
                  class="tag is-warning"
                >PTA</span>
                <span
                  v-else-if="standard.completed == 'Achieved'"
                  class="tag is-success"
                >{{standard.completed.toUpperCase()}}</span>
                <span
                  v-else-if="standard.completed == 'Merit'"
                  class="tag is-info"
                >{{standard.completed.toUpperCase()}}</span>
                <span
                  v-else-if="standard.completed == 'Excellence'"
