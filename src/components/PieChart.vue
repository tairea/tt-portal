<template>
    <canvas v-if="!subjectName" v-bind:id="studentName+'Chart'" class="pie" :style="{height: height + 'px', width: width + 'px'}"></canvas>
    <canvas v-else v-bind:id="studentName+subjectName+'Chart'" class="pie" :style="{height: height + 'px', width: width + 'px'}"></canvas>
</template>
...
<script>
    ...
    export default {
        name: 'PieChart',
        props: ['studentName', 'student', 'subjectName', 'standards', 'height', 'width', 'labels'],
        components: {
